        ...
        <form className="sign-up-form">
            <div className="necessary-section">
                ...
                <div className="necessary-input-wrap">
                    ...
                    <label><input type="password" className="password input-box" placeholder="* 비민번호 (영문+숫자, 8~20자)"/></label>
                    ...
                    <div className="phone-info-wrap">
                        <label className="phone-number-label"><input type="text" className="input-box" placeholder="* 휴대폰"/></label>
                        <label className="phone-auth-btn-label"><input type="button" className="phone-auth-btn input-box" value="인증받기"/></label>
                    </div>
